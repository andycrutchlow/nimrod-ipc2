...
public enum SocketType
{
     ...
     * <br>
     * When a DEALER socket is connected to a {@link ZMQ#REP} socket each message sent must consist of
     ...
     * <table border="1">
     * <caption><strong>Summary of socket characteristics</strong></caption>
     * <tr><td>Compatible peer sockets</td><td>{@link SocketType#SERVER}</td></tr>
     * <tr><td>Direction</td><td>Bidirectional</td></tr>
     * <tr><td>Send/receive pattern</td><td>Unrestricted</td></tr>
     * <tr><td>Outgoing routing strategy</td><td>Round Robin</td></tr>
     * <tr><td>Incoming routing strategy</td><td>Fair-queued</td></tr>
     ...
     * <table border="1">
     * <caption><strong>Summary of socket characteristics</strong></caption>
     * <tr><td>Compatible peer sockets</td><td>{@link SocketType#CLIENT}</td></tr>
     * <tr><td>Direction</td><td>Bidirectional</td></tr>
     * <tr><td>Send/receive pattern</td><td>Unrestricted</td></tr>
     * <tr><td>Outgoing routing strategy</td><td>See text</td></tr>
     * <tr><td>Incoming routing strategy</td><td>Fair-queued</td></tr>
     ...
     * <table border="1">
     * <caption><strong>Summary of socket characteristics</strong></caption>
     * <tr><td>Compatible peer sockets</td><td>{@link SocketType#DISH}</td></tr>
     * <tr><td>Direction</td><td>Unidirectional</td></tr>
     * <tr><td>Send/receive pattern</td><td>Send only</td></tr>
     * <tr><td>Outgoing routing strategy</td><td>Fan out</td></tr>
     * <tr><td>Incoming routing strategy</td><td>N/A</td></tr>
     ...
     * Initially a DISH socket is not subscribed to any groups, use {@link ZMQ.Socket#join(String)} to join a group.
     * To get the group the message belong, call {@link ZFrame#getGroup()}.
     * The {@link ZMQ.Socket#send(byte[], int)} function is not implemented for this socket type.
     *
     * <p>
     ...
     * <table border="1">
     * <caption><strong>Summary of socket characteristics</strong></caption>
     * <tr><td>Compatible peer sockets</td><td>{@link SocketType#RADIO}</td></tr>
     * <tr><td>Direction</td><td>Unidirectional</td></tr>
     * <tr><td>Send/receive pattern</td><td>Receive only</td></tr>
     * <tr><td>Outgoing routing strategy</td><td>N/A</td></tr>
     * <tr><td>Incoming routing strategy</td><td>Fair-queued</td></tr>
     ...
     * any {@link ZMQ.Socket#send(byte[], int)} operations on the socket shall block until the peer
     ...
     * then any {@link ZMQ.Socket#send(byte[], int)} operations on the socket shall block until the mute
     ...
     * <table border="1">
     * <caption><strong>Summary of socket characteristics</strong></caption>
     * <tr><td>Compatible peer sockets</td><td>{@link SocketType#GATHER}</td></tr>
     * <tr><td>Direction</td><td>Unidirectional</td></tr>
     * <tr><td>Send/receive pattern</td><td>Send only</td></tr>
     * <tr><td>Outgoing routing strategy</td><td>Round-robin</td></tr>
     * <tr><td>Incoming routing strategy</td><td>N/A</td></tr>
     ...
     * connected upstream nodes. The {@link ZMQ.Socket#send(byte[], int)} function is not implemented for
     * this socket type.
     * </p>
     * <p>
     ...
     * <table border="1">
     * <caption><strong>Summary of socket characteristics</strong></caption>
     * <tr><td>Compatible peer sockets</td><td>{@link SocketType#SCATTER}</td></tr>
     * <tr><td>Direction</td><td>Unidirectional</td></tr>
     * <tr><td>Send/receive pattern</td><td>Receive only</td></tr>
     * <tr><td>Outgoing routing strategy</td><td>N/A</td></tr>
     * <tr><td>Incoming routing strategy</td><td>Fair-queued</td></tr>
